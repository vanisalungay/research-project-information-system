...
public class EmailService {
    ...
    public void sendApprovalEmail(String toEmail, String name) {
        try {
            ...
            message.setText("Dear " + name + ",\n\n" +
                    "Your registration for the Research Project Information System (RPIS) has been reviewed and approved by the RPS Admin.\n\n"
                    +
                    "You can now log in to the system.\n\n" +
                    "Best regards,\n" +
                    "Research and Publication Services (RPS Admin");
            ...
            System.out.println("[MOCK EMAIL LOG] To: " + toEmail + " | Subject: RPIS Account Approved | Body: Hello "
                    + name + ", your account is approved.");
        }
    }
    ...
    public void sendRejectionEmail(String toEmail, String name) {
        try {
            ...
            System.out.println(
                    "[MOCK EMAIL LOG] To: " + toEmail + " | Subject: RPIS Account Registration Status | Body: Hello "
                            + name + ", your account request was not approved.");
        }
    }
}
